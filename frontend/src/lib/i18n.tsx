...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'library.matchAny': 'Any tag',
    'library.matchAll': 'All tags',
    'library.matchHint': 'Switch between matching any or all selected tags',
    'library.manageTags': 'Manage tags',
    'library.speakerFilter': 'Filter by speaker',
    'library.allSpeakers': 'All speakers',
    'library.manageSpeakers': 'Manage speakers',
    ...
    'speakers.subtitle': 'Rename or remove the speaker labels used across your mathom.',
    'speakers.search': 'Search speakers…',
    'speakers.empty': 'No matching speakers yet.',
    'speakers.name': 'Speaker name',
    'speakers.count_one': '{count} mathom',
    'speakers.count_other': '{count} mathoms',
    'speakers.rename': 'Rename',
    'speakers.delete': 'Remove',
    'speakers.save': 'Save',
    'speakers.cancel': 'Cancel',
    'speakers.saved': 'Speaker renamed.',
    'speakers.deleted': 'Speaker removed from your mathoms.',
    'speakers.confirmDelete': 'Remove “{name}” from every mathom? The recordings will not be deleted.',
    'tags.subtitle': 'Name, colour, and tidy the labels you file recordings under.',
    'tags.newPlaceholder': 'New tag name…',
    'tags.create': 'Create tag',
    'tags.count_one': '{count} mathom',
    'tags.count_other': '{count} mathoms',
    'tags.source': 'Source',
    'tags.sourceLocked': 'Origin tags are applied automatically and cannot be renamed.',
    'tags.rename': 'Rename',
    'tags.save': 'Save',
    'tags.cancel': 'Cancel',
    'tags.delete': 'Delete',
    'tags.confirmDelete': 'Remove the tag “{name}” from every recording?',
    'tags.merge': 'Merge…',
    'tags.mergeInto': 'Merge “{name}” into…',
    'tags.mergePick': 'Choose a tag',
    'tags.mergeConfirm': 'Merge',
    'tags.empty': 'No tags yet. Create one above, or add tags from any recording.',
    ...
    'upload.showSpeakers': 'Show speakers',
    'upload.noSpeakers': 'No matching speakers. Keep typing to add a new one.',
  ...
  de: {
    ...
    'library.untagged': 'Ohne Schlagwort',
    'library.matchAny': 'Beliebiges',
    'library.matchAll': 'Alle',
    'library.matchHint': 'Zwischen beliebigem und allen gewählten Schlagwörtern wechseln',
    'library.manageTags': 'Schlagwörter verwalten',
    'library.speakerFilter': 'Nach Sprecher:in filtern',
    'library.allSpeakers': 'Alle Sprecher:innen',
    'library.manageSpeakers': 'Sprecher:innen verwalten',
    ...
    'speakers.title': 'Sprecher:innen',
    'speakers.subtitle': 'Sprecherbezeichnungen in deinem mathom umbenennen oder entfernen.',
    'speakers.search': 'Sprecher:innen suchen…',
    'speakers.empty': 'Keine passenden Sprecher:innen vorhanden.',
    'speakers.name': 'Name',
    'speakers.count_one': '{count} Mathom',
    'speakers.count_other': '{count} Mathoms',
    'speakers.rename': 'Umbenennen',
    'speakers.delete': 'Entfernen',
    'speakers.save': 'Speichern',
    'speakers.cancel': 'Abbrechen',
    'speakers.saved': 'Sprecher:in umbenannt.',
    'speakers.deleted': 'Sprecher:in aus deinen Mathoms entfernt.',
    'speakers.confirmDelete': '„{name}“ aus allen Mathoms entfernen? Die Aufnahmen werden nicht gelöscht.',
    'tags.subtitle': 'Benenne, färbe und ordne die Etiketten, unter denen du Aufnahmen ablegst.',
    'tags.newPlaceholder': 'Neuer Schlagwortname…',
    'tags.create': 'Schlagwort anlegen',
    'tags.count_one': '{count} Mathom',
    'tags.count_other': '{count} Mathoms',
    'tags.source': 'Quelle',
    'tags.sourceLocked':
      'Herkunfts-Schlagwörter werden automatisch vergeben und können nicht umbenannt werden.',
    'tags.rename': 'Umbenennen',
    'tags.save': 'Speichern',
    'tags.cancel': 'Abbrechen',
    'tags.delete': 'Löschen',
    'tags.confirmDelete': 'Das Schlagwort „{name}“ von jeder Aufnahme entfernen?',
    'tags.merge': 'Zusammenführen…',
    'tags.mergeInto': '„{name}“ zusammenführen mit…',
    'tags.mergePick': 'Schlagwort wählen',
    'tags.mergeConfirm': 'Zusammenführen',
    'tags.empty':
      'Noch keine Schlagwörter. Lege oben eines an oder vergib Schlagwörter aus einer Aufnahme.',
    'tags.created': 'Schlagwort angelegt.',
    'tags.saved': 'Schlagwort aktualisiert.',
    'tags.deleted': 'Schlagwort gelöscht.',
    'tags.merged': 'Schlagwörter zusammengeführt.',
    ...
    'upload.showSpeakers': 'Sprecher:innen anzeigen',
    'upload.noSpeakers': 'Keine Treffer. Tippe weiter, um eine neue Person hinzuzufügen.',
  ...
  es: {
    ...
    'library.untagged': 'Sin etiqueta',
    'library.matchAny': 'Cualquiera',
    'library.matchAll': 'Todas',
    'library.matchHint': 'Alterna entre coincidir con cualquiera o con todas las etiquetas',
    'library.manageTags': 'Gestionar etiquetas',
    'library.speakerFilter': 'Filtrar por voz',
    'library.allSpeakers': 'Todas las voces',
    'library.manageSpeakers': 'Gestionar voces',
    ...
    'speakers.title': 'Voces',
    'speakers.subtitle': 'Cambia o elimina las etiquetas de voz usadas en tu mathom.',
    'speakers.search': 'Buscar voces…',
    'speakers.empty': 'Aún no hay voces coincidentes.',
    'speakers.name': 'Nombre de voz',
    'speakers.count_one': '{count} mathom',
    'speakers.count_other': '{count} mathoms',
    'speakers.rename': 'Cambiar nombre',
    'speakers.delete': 'Eliminar',
    'speakers.save': 'Guardar',
    'speakers.cancel': 'Cancelar',
    'speakers.saved': 'Voz renombrada.',
    'speakers.deleted': 'Voz eliminada de tus mathoms.',
    'speakers.confirmDelete': '¿Eliminar “{name}” de todos los mathoms? Las grabaciones no se eliminarán.',
    'tags.subtitle': 'Nombra, colorea y ordena las etiquetas con las que archivas grabaciones.',
    'tags.newPlaceholder': 'Nombre de la nueva etiqueta…',
    'tags.create': 'Crear etiqueta',
    'tags.count_one': '{count} mathom',
    'tags.count_other': '{count} mathoms',
    'tags.source': 'Fuente',
    'tags.sourceLocked': 'Las etiquetas de origen se aplican automáticamente y no pueden renombrarse.',
    'tags.rename': 'Renombrar',
    'tags.save': 'Guardar',
    'tags.cancel': 'Cancelar',
    'tags.delete': 'Eliminar',
    'tags.confirmDelete': '¿Quitar la etiqueta «{name}» de todas las grabaciones?',
    'tags.merge': 'Fusionar…',
    'tags.mergeInto': 'Fusionar «{name}» en…',
    'tags.mergePick': 'Elige una etiqueta',
    'tags.mergeConfirm': 'Fusionar',
    'tags.empty': 'Aún no hay etiquetas. Crea una arriba o añade etiquetas desde cualquier grabación.',
    ...
    'upload.showSpeakers': 'Mostrar voces',
    'upload.noSpeakers': 'No hay coincidencias. Sigue escribiendo para añadir una voz nueva.',
